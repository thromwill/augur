...
def insert_pr_contributors(contributors: List[dict], augur_db, task_name: str, logger) -> None:
...
def insert_prs(pr_dicts: List[dict], augur_db, task_name: str, logger) -> Optional[List[dict]]:
    ...
    pr_return_data = augur_db.insert_data(pr_dicts, PullRequest, pr_natural_keys, return_columns=pr_return_columns)
...
def insert_pr_labels(labels: List[dict], logger: logging.Logger, augur_db) -> None:
    ...
    augur_db.insert_data(labels, PullRequestLabel, pr_label_natural_keys)


def insert_pr_assignees(assignees: List[dict], logger: logging.Logger, augur_db) -> None:
    ...
    augur_db.insert_data(assignees, PullRequestAssignee, pr_assignee_natural_keys)


def insert_pr_reviewers(reviewers: List[dict], logger: logging.Logger, augur_db) -> None:
    ...
    augur_db.insert_data(reviewers, PullRequestReviewer, pr_reviewer_natural_keys)


def insert_pr_metadata(metadata: List[dict], logger: logging.Logger, augur_db) -> None:
    ...
    augur_db.insert_data(metadata, PullRequestMeta, pr_metadata_natural_keys)
